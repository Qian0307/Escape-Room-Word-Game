...
function triggerEnding() {
  ...
  if (allNpcs && s >= 5 && p >= 30) {
    showEnding('完美結局：真相的見證者',
      '你推開沉重的大門，陽光傾瀉而來，溫暖了你已經麻木的皮膚。\n\n你不僅逃了出去，更帶走了這個設施所有骯髒秘密的證據——主機資料、幽靈檔案、保險庫秘密磁碟，每一份都是鐵證。記者、調查員、受害者家屬……所有人終於得到了他們一直在等待的答案。\n\n設施被徹底調查，幕後黑手被繩之以法。那些消失的人雖然無法復生，但他們的故事被世界知曉。\n\n你成為了歷史的見證者。');
  } else if (hasVaultSecret) {
    showEnding('保險庫真相結局：深淵的帶信人',
      '你緊握著那張秘密磁碟，推開出口大門，走入刺眼的陽光中。\n\n保險庫裡的全息畫面依然在腦中迴盪——那張組織架構圖、那串名單、那些不該被知道的一切。藍色裝置投影出的真相如此龐大，大到讓你的手在發抖。\n\n你知道這張磁碟的存在，意味著有人會想要讓你消失。\n\n但你也知道，如果你不站出來，那個地下室裡幽靈的悲鳴、牆壁裡封存的秘密，將永遠無人知曉。你深吸一口氣，撥通了一個久未聯絡的號碼——\n\n「我有一些東西，你一定想看到。」\n\n真相，比任何密碼都難以解開。而你，選擇成為那把鑰匙。');
  } else if (s >= 5) {
    showEnding('隱藏真相結局：沉默的揭露者',
      '你衝出大門，帶著滿腔的秘密奔向自由。你知道的太多了——多到令人窒息。\n\n在陽光下，你打開了神秘女子給你的藍色磁卡，上面存著完整的設施檔案。你把這些資料傳給了一個可信賴的記者，然後消失在人群中。\n\n真相開始緩慢地擴散……');
  } else {
    showEnding('成功逃脫',
      '你終於推開了那扇門！外面是自由的天空，空氣是如此清新，陽光是如此溫暖。\n\n你不知道自己在那個設施裡度過了多少時間，也不完全明白那裡發生了什麼。但你活著出來了，這已經是最重要的事情。\n\n也許有一天，你會找到勇氣回來揭開那些謎底……');
  }
}
